...
import SetManagerPasswordForm from "@/app/login/components/SetManagerPasswordForm"
import Image from "next/image"

const SetManagerPassword = ({ params }: { params: { email: string } }) => {
    return (
        <div className="w-screen h-screen flex">
            <div className="w-[50%] p-20 flex justify-center flex-col">
                ...
                <SetManagerPasswordForm email={decodeURIComponent(params.email)} />
            </div>
...
export default SetManagerPassword